 ...
 */
final class Version20220702133717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feedback ADD users_id INT DEFAULT NULL, ADD activites_id INT DEFAULT NULL, DROP activite_id, DROP user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feedback ADD activite_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL, DROP users_id, DROP activites_id');
        $this->addSql('ALTER TABLE feedback ADD CONSTRAINT FK_D22944589B0F88B1 FOREIGN KEY (activite_id) REFERENCES activite (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
